...
export const title = "nxt-example";
const description =
  "nxt-example";
const url = `http://localhost`;
const thumbnail = `${url}/public/graphics/thumbnail.png`;
      ...
      <html lang="en">
        <Head>
          ...
          <link
            ...
            sizes="57x57"
            href="./public/graphics/icon-57.png"
          />
          <link
            rel="apple-touch-icon"
            sizes="72x72"
            href="./public/graphics/icon-72.png"
          />
          <link
            rel="apple-touch-icon"
            sizes="114x114"
            href="./public/graphics/icon-114.png"
          />
          <link
            rel="apple-touch-icon"
            sizes="144x144"
            href="./public/graphics/icon-144.png"
          />
          <link
            rel="apple-touch-icon"
            sizes="512x512"
            href="./public/graphics/icon-512.png"
          />
          <link
            href="./public/graphics/splash-2048.png"
            media="(device-width: 1024px) and (device-height: 1366px) and (-webkit-device-pixel-ratio: 2)"
            rel="apple-touch-startup-image"
          />
          <link
            href="./public/graphics/splash-1668.png"
            media="(device-width: 834px) and (device-height: 1112px) and (-webkit-device-pixel-ratio: 2)"
            rel="apple-touch-startup-image"
          />
          <link
            href="./public/graphics/splash-1536.png"
            media="(device-width: 768px) and (device-height: 1024px) and (-webkit-device-pixel-ratio: 2)"
            rel="apple-touch-startup-image"
          />
          <link
            href="./public/graphics/splash-1125.png"
            media="(device-width: 375px) and (device-height: 812px) and (-webkit-device-pixel-ratio: 3)"
            rel="apple-touch-startup-image"
          />
          <link
            href="./public/graphics/splash-1242.png"
            media="(device-width: 414px) and (device-height: 736px) and (-webkit-device-pixel-ratio: 3)"
            rel="apple-touch-startup-image"
          />
          <link
            href="./public/graphics/splash-750.png"
            media="(device-width: 375px) and (device-height: 667px) and (-webkit-device-pixel-ratio: 2)"
            rel="apple-touch-startup-image"
          />
          <link
            href="./public/graphics/splash-640.png"
